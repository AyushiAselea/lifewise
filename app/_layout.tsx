  ...
  return (
    <>
      ...
      <Stack screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="member-dashboard" options={{ animation: 'slide_from_right' }} />
        <Stack.Screen name="health-monitoring" options={{ presentation: 'modal', animation: 'slide_from_bottom' }} />
